...
<div id="container">	
	...
	<div id="mid">
		<div id="content" style="width:100%;">
			...
			%>
			<br>
			<form action="Client/clientchecklogin.jsp" name="currentForm" method="post" onsubmit="return(checkFields())" style="background-color:#E5E5E5;border:#0066CC solid 3px;width:40%;border-radius:20px;">
			<h2 style="color:#0066CC;font-size:20px;"><i>Members Area</i></h2>
			<table cellpadding=5>
