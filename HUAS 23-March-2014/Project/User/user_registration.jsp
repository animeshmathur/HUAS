	...
	<div id="reg_area">
			...
			<tr><td>User ID <font color=red>*</font> :</td><td><input class="reg_input" type="text" name="userid"></td></tr>
			<tr><td>Password <font color=red>*</font> :</td><td><input class="reg_input" type="text" name="pwd"></td></tr>
			<tr><td>Re-enter Password <font color=red>*</font> :</td><td><input class="reg_input" type="text" name="rpwd"></td></tr>
			...
			<tr><td>Contact Number:</td><td><input class="reg_input" type="tel" name="user_contact"></td></tr>
			<tr><td>Email:</td><td><input class="reg_input" type="email" name="user_email"></td></tr>
			</table>
			<br>
