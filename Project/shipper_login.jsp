...
<div id="container">	
	...
	<div id="mid">
		<div id="content" style="width:100%;">
			...
			%>
			<br>
			<form action="Shipper/shipperchecklogin.jsp" name="currentForm" method="post" onsubmit="return(checkFields())" style="background-color:#E5E5E5;border:#0066CC solid 3px;width:40%;border-radius:20px;">
			<h3 style="color:#0066CC;font-size:20px;">::<i>&nbsp;Shipper Login&nbsp;</i>::</h3>
			<table cellpadding=5>
