<%@ include file="include_top.jsp"%>
		...
		<div id="buyer" style="width:85%;border-bottom-style:solid;border-bottom-width:thin;border-bottom-color:#0066CC">
			<center>
			<h3 style="color:#0066CC"><img src="images/buyer.jpeg" height=60 width=65>&nbsp;&nbsp;<span class="orange_color">::</span> Buyers <span class="orange_color">::</span></h3>
		...
		<div id="seller" style="width:85%;color:#0066CC;border-bottom-style:solid;border-bottom-width:thin;border-bottom-color:#0066CC">
			...
			<br>
			<span id="seller_text">
			<h3 style="color:#0066CC"><img src="images/seller.jpg" height=60 width=65>&nbsp;&nbsp;<span class="orange_color">::</span> Sellers <span class="orange_color">::</span></h3>
