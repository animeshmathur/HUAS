...
if(rs.next())
{
	do
	{
		...
		<tr>
		<td>
		<button onclick="return(viewItemInfo('<%=rs.getString(1)%>'));" class="item_button" style="height:120px;width:100%;background-color:#FFFFFF;border-color:#CACACA;border-style:groove;border-width:thin;">
		<table cellpadding="6" cellspacing="5" style="width:100%;text-align:center;font-size:13px;">
		<tr>
			<td class="items" style="text-align:center;">
				<img src="uploads/<%=rs.getString(5)%>" alt="<%=rs.getString("seller_item_name")%>" height="60px"><br><br>
				<%
