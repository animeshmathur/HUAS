...
%>
		...
		function()
		{
			$("#rent_field_form").hide();
                        $("#rent_field_form").css("visibility","visible");
		}
		);
		...
		function()
		{
			...
			function()
			{
				$("#rent_field_form").toggle(
                                function(){$("#rent_field_text").toggle();});
			}
			);
		}
		);
		...
		<script type="text/javascript">
			document.write("<b><a href=\""+document.referrer+"\" style=\"color:#0066CC\">&lt;&lt; Back</a></b>");
		</script>
		...
		<center>
			...
			<div id="rent_field" style="width:80%;color:#0066CC;border-bottom-style:solid;border-bottom-width:thin;border-bottom-color:#0066CC">
				...
				* * *&nbsp;&nbsp;<span style="color:#CC6600"><i>Place Your Entity :</i></span>&nbsp;&nbsp;&nbsp;<button class="rent_field_button" style="color:#FFFFFF;background-color:#FF6600;width:200px">&nbsp;For Rent&nbsp;</button>&nbsp;&nbsp;* * *
				...
				<span id="rent_field_form" style="visibility:hidden;">
			...
			<br><br>
			<%
			rs=smt.executeQuery("select * from user_rents where category_id='"+cat_id+"'");
			if(rs.next())
			{
				do
				{
					...
					%>
					<span style="width:30%;float:left;border:thick solid #FFFFFF;">
						<table cellpadding="5" style="background-color:#FFFFAA;width:100%;;font-size:12px;padding:5px;border:#0066cc groove thin;">
							<tr>
								<td>
							...
							//{
								...
								<tr>
									<td>
										<textarea rows="2" style="color:#4d4c4c;width:100%;background-color:#FFFFAA;border-width:0px;font-weight:bold;font-size:13px;resize:none;text-align:center;" readonly="true" disabled><%=rs.getString("rent_details")%></textarea>
									</td>
								</tr>
								<%
							//}
					...
					<%
                        ...
                        {
                            %>
                            <b><span style="color:#FF6666;font-size:16px;">* No rentable listed yet in this category. *</span></b>
                            <%
                        }
			%>
			</div>
